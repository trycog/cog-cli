...
### NOT_SUPPORTED Tools Summary (DAP/Delve)

The following tools return error code -32001 (NOT_SUPPORTED) when used with the Go DAP backend:

| Tool | Verified in Scenario |
|------|---------------------|
| `debug_memory` | 14, 33 |
| `debug_disassemble` | 14 |
| `debug_registers` | 16, 33 |
