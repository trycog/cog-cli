...
pub const debug_serve =
    ...
    ++ "  that AI agents can use to step-debug programs.\n"
    ++ "\n"
    ++ cyan ++ bold ++ "  Usage" ++ reset ++ "\n"
    ++ "    cog debug/serve\n"
    ++ "\n"
    ...
    ++ "    " ++ bold ++ "debug_attach" ++ reset ++ "          " ++ dim ++ "Attach to a running process" ++ reset ++ "\n"
    ++ "    " ++ bold ++ "debug_breakpoint" ++ reset ++ "      " ++ dim ++ "Set, remove, or list breakpoints" ++ reset ++ "\n"
    ++ "    " ++ bold ++ "debug_watchpoint" ++ reset ++ "      " ++ dim ++ "Set data breakpoints on variables" ++ reset ++ "\n"
    ...
    ++ "    " ++ bold ++ "debug_set_variable" ++ reset ++ "    " ++ dim ++ "Set a variable value in current scope" ++ reset ++ "\n"
    ++ "    " ++ bold ++ "debug_set_expression" ++ reset ++ "  " ++ dim ++ "Evaluate and assign an expression" ++ reset ++ "\n"
    ++ "    " ++ bold ++ "debug_threads" ++ reset ++ "         " ++ dim ++ "List threads in the debug session" ++ reset ++ "\n"
    ++ "    " ++ bold ++ "debug_stacktrace" ++ reset ++ "      " ++ dim ++ "Get stack trace for a thread" ++ reset ++ "\n"
    ++ "    " ++ bold ++ "debug_scopes" ++ reset ++ "          " ++ dim ++ "List variable scopes for a frame" ++ reset ++ "\n"
    ++ "    " ++ bold ++ "debug_completions" ++ reset ++ "     " ++ dim ++ "Get expression completions" ++ reset ++ "\n"
    ++ "    " ++ bold ++ "debug_memory" ++ reset ++ "          " ++ dim ++ "Read or write process memory" ++ reset ++ "\n"
    ++ "    " ++ bold ++ "debug_registers" ++ reset ++ "       " ++ dim ++ "Read or write CPU registers" ++ reset ++ "\n"
    ++ "    " ++ bold ++ "debug_disassemble" ++ reset ++ "     " ++ dim ++ "Disassemble instructions at an address" ++ reset ++ "\n"
    ++ "    " ++ bold ++ "debug_modules" ++ reset ++ "         " ++ dim ++ "List loaded modules and libraries" ++ reset ++ "\n"
    ++ "    " ++ bold ++ "debug_loaded_sources" ++ reset ++ "  " ++ dim ++ "List available source files" ++ reset ++ "\n"
    ++ "    " ++ bold ++ "debug_source" ++ reset ++ "          " ++ dim ++ "Retrieve source code by reference" ++ reset ++ "\n"
    ++ "    " ++ bold ++ "debug_exception_info" ++ reset ++ "  " ++ dim ++ "Get details about current exception" ++ reset ++ "\n"
    ++ "    " ++ bold ++ "debug_capabilities" ++ reset ++ "    " ++ dim ++ "Query driver capabilities" ++ reset ++ "\n"
    ++ "    " ++ bold ++ "debug_restart_frame" ++ reset ++ "   " ++ dim ++ "Restart from a stack frame" ++ reset ++ "\n"
    ++ "\n"
